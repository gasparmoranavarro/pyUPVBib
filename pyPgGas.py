...
class ConectaPg(object):
    ...
    """
    def __init__(self,database, user, password,host, port,connection_timeout=None, statement_timeout=None):
        """
        Constructor:
    ...
    def __set_conn(self,cad_conn):
        ...
        try:
            ...
            #settrace()
            if self.statement_timeout!=None:
                consulta="set statement_timeout to " + str(self.statement_timeout)
